...
for s in run_qc run_noise run_ruler run_linefit run_trim_report \
         run_beta_self run_beta_self_theory run_global_fit run_lever_crosscheck run_laser_epoch \
         ...
         run_polarizability run_polarizability_deep run_window_laws run_four_peak_contrasts run_density_laws run_ladder_terms run_far_wing_level run_cross_arm_ratios run_detection_budget run_resolving_power run_projections \
         ...
         run_fringe_rho_recovery run_twin_completeness make_model_terms; do
    echo "== scripts/$s.py =="
    python scripts/$s.py
done
