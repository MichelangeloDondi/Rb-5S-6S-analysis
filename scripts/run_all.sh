...
for s in run_qc run_noise run_ruler run_linefit run_trim_report \
         ...
         run_polarizability run_polarizability_deep run_window_laws run_four_peak_contrasts run_density_laws run_far_wing_level run_cross_arm_ratios run_detection_budget run_resolving_power run_projections \
