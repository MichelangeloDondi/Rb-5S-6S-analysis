...
def main() -> int:
    ...
    if sj:
        ...
        W(f"- **C3f. The joint three-session fit puts the light-shift bound "
          ...
          f"variance at fixed code. **The two single-session subsets do carry "
          f"optimizer-path sensitivity, measured 2026-08-14:** a second rerun "
          f"on byte-identical data inputs but eight days of later code "
          f"reproduced all three primary bounds to the printed digit while "
          f"the campaign-only and power-ladder-only bounds moved 29 and 35 "
          f"per cent, both tightening. Those two are partial "
