...
def main() -> int:
    ...
    W("- **C3c — the RAMP asymmetry is a bound; the significant low-power skew in "
      ...
      "crossover the apparatus sits on depends on the collection geometry "
      "($Z_c = L_\\parallel/2M$), which is unmeasured -- though because the PMT is "
      "not re-oriented between configurations, $Z_c$ is a single fixed unknown "
      "and the flip needs only $0.90$ mm $< Z_c < 12.7$ mm, a window spanning "
