...
def main() -> int:
    ...
    if ss:
        ...
        W(f"- **C3d. The AC-Stark coefficient from the power lever is an upper bound, "
          ...
          f"**Those two factors have no `results/` row and no producer regenerates "
          f"them**: they come from a companion note whose own producers compute "
          f"them and print them without writing anything, by their own stated "
          f"design. They are not withdrawn and neither is known to be wrong, and "
          f"they stand on a weaker footing than every bound on this page. "
