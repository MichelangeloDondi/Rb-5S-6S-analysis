...
def main() -> int:
    ...
    W("Generated by `scripts/make_results_ledger.py` from the committed "
      ...
      "noted, because they ride on the beam waist $w_0$, which this archive "
    ...
    W("> **The dominant systematic is the beam waist $w_0$. It is a measured "
      "value on this apparatus lineage, and what this archive cannot do is "
      ...
      "than inferred from our own line, and the retro ratio is "
      ...
      "degeneracy means the archival line cannot pin $w_0$ itself, which is "
    ...
    W("- **C3b amplitude $\\propto P^2$:** log-log slopes 1.83–2.12 (the two-photon "
      ...
      "test: the archival sweep is single-temperature (130 °C, one $\\tau$), so the "
    ...
    if sj:
        ...
        W(f"- **C3f. The joint three-session fit puts the light-shift bound "
          ...
          f"is the "
          f"2025-07-04 LeCroy dress rehearsal (46 usable traces at 90/180/270 "
          ...
          f"dropped (which removes the entire pilot). An identical-input rerun "
          f"of the archive-wide construction reproduces its primary and every "
          f"subset bound to the printed digit ([the reproducibility "
          f"preregistration](notes/m28_reproducibility_prereg.md), adjudicated "
          f"branch one, 2026-08-06), so spreads of this family are properties "
          f"of the subsets, not of the optimizer. The primary and the "
          ...
          + (f"moves no $\\chi^2$ by more than "
             ...
             "flipped rehearsal axis, though the converged wing-variant pair "
             "of the "
    ...
    if ar:
        W("- **Degeneracy law:** areas should be abundance×(2F+1) "
          ...
          "between "
          "blocks with drift. It is not testable in the archive, and a fixed-lock "
