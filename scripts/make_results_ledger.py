...
def main() -> int:
    ...
    if sj:
        ...
        W(f"- **C3f. The joint three-session fit puts the light-shift bound "
          ...
          f"the opposite direction. **DIAGNOSED 2026-08-20, and the inputs "
          ...
          f"change amplified by a loose readout rather than an arithmetic "
          f"defect, the primary bound is untouched, and the phrase "
