...
def main() -> int:
    ...
    if pol:
        ...
        W(f"- **Dynamic polarizabilities:** this record's sum-over-states model "
          ...
          f"The static-tail sum this bullet quoted until 2026-09-17 stays reproducible as "
          f"`rb5s6s.polarizability.delta_alpha(993.4181)`. The sign was fixed by decision on "
          f"2026-08-24 and ruled on 2026-09-17, a decision on the theory and not a measurement, "
          ...
          f"active clock. Two of them bracket the 1339.6 here, which is expected: "
          f"every 6S-involving root in this band is penned into the 43 nm window "
          f"between the two 6S-5P resonances. Different state "
          f"pair and different magic condition, so the claim is specifically "
          f"5S–6S. A "
