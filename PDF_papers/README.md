...
| `Nieddu_2019_993nm-5S-6S-two-photon-frequency-reference.pdf` | nieddu2019 | the group's 993 nm frequency reference — same channel, 2019 baseline | **DONE (turn A)**: measured beam **1/e² diam 128 µm ⇒ w₀=64 µm** (f=150 mm) — corroborates the w₀ re-pin; 4 peaks FWHM 2.43–2.60 MHz laser-axis ≈5 MHz transition (corroborates our width); laser ~100 kHz |
