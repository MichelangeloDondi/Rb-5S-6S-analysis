...
- **The correct transit at the nominal w₀ = 32 µm is 1.87 MHz** (bare, transition
  ...
  draft also alleged a second, laser-vs-transition "factor of 2" bug, and it was
...
because the right comparison is broadening-to-broadening. Conclusion unchanged
...
Stark data against, and worth adopting rather than re-deriving. (Also: his
2nd-order Doppler shift $-\omega v^2/2c^2$ is ~tens of Hz, negligible for us,
which is one less systematic to worry about.)
