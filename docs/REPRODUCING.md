...
`make_model_terms.py` (`model_terms.csv` and `docs/methods/model_terms.md`, the model-terms registry rendered
from `rb5s6s/model_registry.py`, under a second) runs after the analysis stages and before the status column.
