...
[2442](../../results/moment_admission.csv "ref:moment_admission:snr_mu2:6") per
trace. The third carries
[0.1595](../../results/moment_admission.csv "ref:moment_admission:snr_mu3:6"),
...
[6.773](../../results/moment_admission.csv "ref:moment_admission:effective_rank_admitted:")
...
[10.338](../../results/moment_admission.csv "ref:moment_admission:effective_rank_all:")
...
[2.98](../../results/window_laws.csv "ref:window_laws:law_tilt_mu2:4-20") on the
second moment and to the
[5.561](../../results/window_laws.csv "ref:window_laws:law_tilt_mu3:4-20") on the
third, steeper than any physics term. The transit's second moment grows to
the [1.09](../../results/window_laws.csv "ref:window_laws:law_transit_mu2:4-20"),
the Lorentzian sum's to the
[1.733](../../results/window_laws.csv "ref:window_laws:law_lorentzian_sum_mu2:4-20"),
and a Lorentzian laser kernel to the
[1.80](../../results/window_laws.csv "ref:window_laws:law_lorentzian_laser_form_mu2:4-20"),
...
[0.49](../../results/window_laws.csv "ref:window_laws:kept_transit_mu2:1.5-20")
of the transit's sensitivity on the second moment and
[0.70](../../results/window_laws.csv "ref:window_laws:kept_transit_mu6:1.5-20")
on the sixth.
...
[-0.041](../../results/window_laws.csv "ref:window_laws:bias_mu2_white:6") at
6 MHz and
[-0.214](../../results/window_laws.csv "ref:window_laws:bias_mu2_white:12") at
...
[2.98e-08](../../results/fringe_rho_recovery.csv "ref:fringe_rho_recovery:rho_recovery_numerical_floor:single_valued")
...
model-form spread (`results/lever_crosscheck.csv`'s `beta_err_modelform` row)
is **several times the statistical error of 0.0043**, so the
choice of kernel form costs several times what the data's own noise
