...
[3.2](../../results/residual_resampling.csv
"ref:residual_resampling:sd_mu4_over_gaussian_corrected:real") times too narrow,
and its variance spread [1.4](../../results/residual_resampling.csv
"ref:residual_resampling:sd_mu2_over_gaussian:real") times. The covariance that
...
[0.92](../../results/residual_resampling.csv
