...
|---|---|---|
| 993.4121 | $^{87}\text{Rb}$, $F=1$ | 0.3725 <!-- other-quantity: a hyperfine branching fraction, not an identifiability-profile cell --> |
| 993.4154 | $^{85}\text{Rb}$, $F=2$ | 0.3476 <!-- other-quantity: a branching fraction --> |
