...
nm to the record's own 1204 nm crossing, and its inputs reproduce from this
repository's modules: the ground-state polarizability is 687.4 a.u. at 1064 nm
and 546.8 at [1203.7](../../results/polarizability.csv "ref:polarizability:magic_5s6s:1204nm"), so about 1.26 times the red power restores the depth, and
...
[0.0073142](../../results/platform_twins.csv "ref:platform_twins:hcpcf_warm:hcpcf:absorbed_fraction")
...
MHz against
[1.44593](../../results/platform_twins.csv "ref:platform_twins:cell_130C:cell:transit_fwhm_mhz").
