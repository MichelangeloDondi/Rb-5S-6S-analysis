...
addendum 29. Its drift prior is directional, the 68 per cent band +0.007 to +0.025 MHz/min, and the
...
**M27's drift prior is one correction behind.** It uses the 68 per cent band +0.007 to
+0.025 MHz/min as a directional prior. The 2026-07-30 window-reference correction downgraded that
