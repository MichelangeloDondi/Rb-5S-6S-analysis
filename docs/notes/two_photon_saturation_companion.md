...
check (+0.18 +/- 0.12 MHz on the 25 to 125 mW subset against -0.152 +/- 0.030 MHz on 75
...
postscript reports as pulled by -0.29 +/- 0.20 MHz when the Gaussian width is freed
