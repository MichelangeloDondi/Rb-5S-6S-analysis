...
| [centre_channel_cannot_be_revived.md](centre_channel_cannot_be_revived.md) | Why the line-centre AC-Stark lever cannot be recovered from this archive: a calibrated forecast of what each session could deliver, then the obstruction that spends it in each one, and the single measurement that would reopen the channel. | record |
