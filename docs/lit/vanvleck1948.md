...
verify_flags:
  ...
  - 'Absent from the paper, checked because an earlier draft asserted it: any treatment of
    ...
    liquid case is Bloembergen, Pound and Purcell, which he declines to treat (p. 1182).'
...
summary: >
  ...
  reference. Paywalled (APS Physical Review Archive); not fetched.
loci:
  - methods/06
  - THEORY
...
REPORTED. Not held: behind the American Physical Society's Physical Review Archive paywall (a
1948 paper, well before APS's open legacy-access programs), no open-access or preprint copy
located by search on 2026-09-21. Everything below is second-hand.
