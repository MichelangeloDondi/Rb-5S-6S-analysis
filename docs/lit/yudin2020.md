...
summary: >
  The general theory of the suppress-the-mean school: two power-modulation
  servo schemes (PM-CES, PM-ACS) that null the clock output's light shift,
  with the shift modelled as one scalar, linear in the dialed power. No
  distribution, no moments, no spatial treatment anywhere. The cleanest
  general statement of the approach this programme's method complements.
loci:
  - THEORY
  - P1
section: prior-art
