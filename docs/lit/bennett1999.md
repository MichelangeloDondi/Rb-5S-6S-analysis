...
Cesium's 6S-7S pair is the alkali nS to (n+1)S sibling of Rb 5S-6S: both are S-to-S transitions coupled only through intervening P states, and in both atoms the differential scalar polarizability of the pair, Delta_alpha = alpha_(n+1)S minus alpha_nS, is the quantity theory and experiment are compared against. This repository's `constants.py` pins DELTA_ALPHA_AU = [-1131.8](../../results/polarizability_deep.csv "ref:polarizability_deep:delta_alpha:at_drive") a.u., alpha(6S) minus alpha(5S) for Rb at 993 nm, from its own dynamic sum over states, and keeps [orson2021](orson2021.md)'s +1093 beside it as DELTA_ALPHA_AU_ORSON2021. Bennett's k is the Cs analog of that quantity, alpha(7S) minus alpha(6S), at zero frequency.
