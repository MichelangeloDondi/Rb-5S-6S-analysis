...
Cesium's 6S-7S pair is the alkali nS to (n+1)S sibling of Rb 5S-6S: both are S-to-S transitions coupled only through intervening P states, and in both atoms the differential scalar polarizability of the pair, Delta_alpha = alpha_(n+1)S minus alpha_nS, is the quantity theory and experiment are compared against. This repository's `constants.py` pins DELTA_ALPHA_AU = 1093.0 a.u., alpha(6S) minus alpha(5S) for Rb at 993 nm, sourced from [orson2021](orson2021.md). Bennett's k is the Cs analog of that quantity, alpha(7S) minus alpha(6S), at zero frequency.
