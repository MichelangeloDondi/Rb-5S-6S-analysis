...
cent, a check of 2026-09-24), under the [0.7290](../../results/stark_sweep.csv "ref:stark_sweep:S0_225mW_pred:shared") MHz predicted at the waist convention, so the $\Delta\alpha$
