...
not refute the candidate. The retro mirror sits 25 to 35 mm behind an f = 150 lens
...
1.5 to 1.7 times the mirror tilt, so 3.2 to 3.5 mrad would give 2.2 to 2.6 MHz
...
|---|---|---|---|
| four peaks, 6 GHz | 35,556 | 213,333 | 1.07 MSample <!-- other-quantity: a record length in samples --> |
