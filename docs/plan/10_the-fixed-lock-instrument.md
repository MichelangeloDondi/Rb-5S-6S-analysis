...
7. An independent measurement of the laser width, which 10c.1 argues is worth
   ...
   kHz and saw 2.43 to 2.60 MHz per photon, which is 4.86 to 5.20 on the <!-- other-quantity: the laser-axis FWHM range, not the tilt table's residual-over-transit ratio -->
