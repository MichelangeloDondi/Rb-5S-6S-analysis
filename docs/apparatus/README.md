...
| `2025-07-18_wavemeter_relock_settling.jpg` | The one in-campaign wavemeter record, taskbar clock reading 17:03, showing the re-lock transient after the daytime break with the instrument's own statistics panel in shot. | 2025-07-18 | §6 Laser drift |
