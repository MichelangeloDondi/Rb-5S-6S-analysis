...
tests/    3646-test battery (3600 fast ~5 min + 46 `slow` high-statistics
...
pip install -e ".[dev]" && pytest -q          # 3600 fast tests (~5 min)
pytest -q --runslow                           # full 3646 incl. slow closures (what CI runs)
