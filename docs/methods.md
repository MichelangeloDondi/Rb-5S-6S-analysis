...
tests/    5623-test battery (5437 fast ~5 min + 186 `slow` high-statistics
...
pip install -e ".[dev]" && pytest -q          # 5437 fast tests (~5 min)
pytest -q --runslow                           # full 5623 incl. slow closures (what CI runs)
