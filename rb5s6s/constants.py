...
value. The static construction, alpha_6s - alpha_5s of rb5s6s.polarizability before C6b made
9P and 10P explicit there (2026-09-25; reproducible at 6df76d45 as delta_alpha(993.4)), is the
earlier one, replaced 2026-09-15 by the dynamic sum above;
...
(lineshape.RAMP_SIDE); mean pull +(2/3) S0; third moment -S0^3/135 (the fringe-mean, focal Z->0 limit;
...
skew -- mu3 -> -S0^3 (1/135 - f_res*sigma_x^2/5) (= -1/135 + f_res/10 at rho=1),
...
that combination is preferred -- S0/(transit)^2 and sqrt(mu2)/(transit)^2 are proportional to
